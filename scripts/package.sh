#!/usr/bin/env bash
# Build youtube.zip (manifest.json at ROOT — required by install_plugin_from_zip)
...
FILE_URL="https://github.com/outcast1000/viboplr-youtube/releases/latest/download/youtube.zip"
...
rm -f youtube.zip
zip -q youtube.zip manifest.json index.js
...
echo
echo "To publish:"
echo "  gh release create v${VERSION} youtube.zip update.json --repo outcast1000/viboplr-youtube --title \"v${VERSION}\" --notes-file CHANGELOG.md"
